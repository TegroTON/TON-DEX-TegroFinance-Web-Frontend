      ...
      <div class="col-lg-7 col-xl-5 mx-auto">
         ...
         <div class="card">
            ...
            <form action="">
               ...
               <ul class="list-unstyled bg-light p-3 rounded-8 mb-0">
               ...
               <div class="mt-4">
                  <button type="button" class="btn btn-green w-100" data-bs-toggle="modal" data-bs-target="#ProcessingModal">Exchange</button>
                  <!--button type="button" class="btn btn-outline-green disabled w-100" data-bs-toggle="modal" data-bs-target="#ProcessingModal">Enter an amount</button-->
               </div>
            </form>
         </div>
      </div>
