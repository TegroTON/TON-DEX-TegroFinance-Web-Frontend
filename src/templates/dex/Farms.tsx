...
import { Container, Row, Col, Card, Button, ButtonGroup, Form, InputGroup, Dropdown, Nav, Stack, ListGroup, Accordion, ProgressBar, OverlayTrigger, Tooltip, Badge } from "react-bootstrap";
    ...
    return (
        <>
            ...
            >
                <Container>
                    <Row className="align-items-center">
                        <Col md={6} xl={5}>
                            <h1 className="fw-800 mb-2" style={{fontSize: '50px'}}>Farms</h1>
                            <p className="mb-3 mb-md-4 pb-0 pb-md-3 fs-18 color-grey">
                                Stake your LP tokens and earn TGR tokens in return. 
                                <span className="d-none d-md-inline">We incentivize many liquidity pairs by offering our</span>
                                <span className="d-none d-md-inline">Liquidity Providers best farming opportunities.</span>
                            </p>
                            <Button variant="primary d-block d-md-inline" href="#addproject">Add project</Button>
                        </Col>
                        <Col md={6} xl={4} className="ms-auto text-center d-none d-md-block">
                            <img src="./assets/images/girl-image.png" alt="Tegro Farms" width={244} height={310} />
                        </Col>
                    </Row>
                </Container>
            </section>
            ...
            >
                <Container>
                    <Row>
                        <Col lg={6} className="d-flex align-items-center mb-4 mb-lg-0 order-1">
                            <Nav
                                justify
                                variant="pills"
                            ...
                            >
                                <Nav.Item>
                                    <a href="#!" className="nav-link btn active py-2 fs-14">Live</a>
                                </Nav.Item>
                                <Nav.Item>
                                    <a href="#!" className="nav-link btn py-2 fs-14">Main</a>
                                </Nav.Item>
                                <Nav.Item>
                                    <a href="#!" className="nav-link btn py-2 fs-14">Innovation</a>
                                </Nav.Item>
                                <Nav.Item>
                                    <a href="#!" className="nav-link btn py-2 fs-14">GameFi</a>
                                </Nav.Item>
                                <Nav.Item>
                                    <a href="#!" className="nav-link btn py-2 fs-14">Archive</a>
                                </Nav.Item>
                            </Nav>
                        </Col>
                    ...
                    <Card className="p-0">
                        {showFarmsTable ? (
                            ...
                            <div className="d-flex justify-content-center m-4">
                                <div className="badge bg-soft-red fs-14 fw-500 p-3 rounded-8 m-0" style={{ maxWidth: '150px' }}>
                                    No data yet
                                </div>
                            </div>
                        )}
                ...
                <Container className="border-bottom py-5">
                    <Row className="align-items-center">
                        <Col lg={6} className="d-none d-lg-block">
                            <img src="./assets/images/planet-image.png" className="section__image" alt="" />
                        </Col>
                        <Col lg={5} className="ms-auto">
                            <h2 className="fs-32 fw-900 mb-3">Launch Your Project <span className="d-block">on Toncoin Now!</span></h2>
                            <p className="mb-4 pb-2 fs-16 color-grey">
                            Tegro Launchpool and Farms are platforms that help project teams promote their token and get exposure to thousands of active Tegro users across the globe. We look for strong teams with clear and innovative vision in the crypto space. If you think you are one of the projects, do not wait any longer and apply below.
                            </p>
                            <Button href="#!" target="_blank">Apply to Launch</Button>
                        </Col>
                    </Row>
                </Container>
            </section>
