...
import {
    Icon20ComputerOutline, Icon20SmartphoneOutline, Icon24Dismiss, Icon28ChevronLeftOutline,
                    ...
                    ? (
                        <div className="delab-modal-content">
                            ...
                            <div className="delab-modal-horizontal">
                                ...
                                <div className="delab-modal-horizontal-block" onClick={() => props.DeLabConnectObject.handleConnectTonkeeper()}>
                                    <div className="delab-icon">
                    ...
                    : (
                        <div className="delab-modal-content">
                            <div className="delab-center-block2">
                                ...
                                <a className="delab-button" target="_blank" href={link} rel="noreferrer">
                                    Open Wallet
                                </a>
                            </div>
